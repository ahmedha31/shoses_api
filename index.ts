...
// aa.data.forEach(async(element) => {
//  await db.product.create({
//     data: {
//       name: element.name,
//       imageUrl: {connectOrCreate: {create: {url: element.image,name:"",}, where: {url: element.image,}}},
//       category: element.sizing,
//       price: element.initialPrice,
//       description: element.colorway,
//       oldPrice: element.initialPrice,
//       title: element.brand.name,
